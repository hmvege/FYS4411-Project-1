...
For solving this many-body problem, I implemented the Hartree-Fock algorithm \ref{alg:hf-algorithm} in \CC. The code can be found by following the GitHub adress given in the reference section \cite.
